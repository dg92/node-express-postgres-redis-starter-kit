echo '******** Welcome to the Ubuntu Setup **********
--------------------------------------------------'

echo 'This will install Prerequisites, Nodejs(latest), Postgres(latest), Redis now and later project
---------------------------------------------------'
cd $HOME
echo 'Update apt-get for you
---------------------------------------------------'
sudo apt-get update -y
echo 'Lets install git now
---------------------------------------------------'
sudo apt-get install git -y
echo 'We need build-essential, lets get that
---------------------------------------------------'
...
---------------------------------------------------'
wget https://nodejs.org/dist/v6.2.2/node-v6.2.2-linux-x64.tar.gz -O node.tar.gz
tar -xzvf node.tar.gz
echo "now moving path"
mv node-v6.2.2-linux-x64 node
rm node.tar.gz
